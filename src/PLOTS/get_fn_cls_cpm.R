...
setwd("~/storage/Data/ms_evo_exwago/analysis/fn_cls/")
tabs = list.files(pattern = "cpm.txt")
...
ggsave("strongylis_fn_cls_simple.pdf", device = "pdf", width = 16, height = 6, dpi = 300,
