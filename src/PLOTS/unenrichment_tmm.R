setwd("~/storage/Data/ms_evo_exwago/analysis/de_tables/tmm_noIP_tabs/")
...
ndf$exp_list = "Percentage of unbound exWAGO sRNAs"
...
ggsave("non_enriched_tmm_exWAGO.pdf", device = "pdf", plot = stak_prop,
...
ggsave("nxHelBake1.1_non_enriched_tmm_exWAGO.pdf", device = "pdf", plot = hb_stak_prop,
